	...
	keys = {
		...
		opts = {
			...
			mappings = {
				...
				submit_win = {
					approve_review = { lhs = "<localleader>ra", desc = "approve review", mode = { "n" } },
					comment_review = { lhs = "<localleader>rc", desc = "comment review", mode = { "n" } },
					request_changes = { lhs = "<localleader>rr", desc = "request changes review", mode = { "n" } },
