...
if [ -z "$TMUX_POWERLINE_LEFT_STATUS_SEGMENTS" ]; then
	TMUX_POWERLINE_LEFT_STATUS_SEGMENTS=(
		"tmux_session_info ${TMUX_POWERLINE_BACKGROUND_COLOR} ${TMUX_POWERLINE_FOREGROUND_COLOR}"
		#"ifstat 30 255"
		#"ifstat_sys 30 255"
		#"lan_ip #0387FF #FFFFFF ${TMUX_POWERLINE_SEPARATOR_RIGHT_THIN}"
		#"vpn 24 255 ${TMUX_POWERLINE_SEPARATOR_RIGHT_THIN}"
		"hostname ${TMUX_POWERLINE_BACKGROUND_COLOR} ${TMUX_POWERLINE_FOREGROUND_COLOR}"
		#"wan_ip ${TMUX_POWERLINE_BACKGROUND_COLOR} ${TMUX_POWERLINE_FOREGROUND_COLOR}"
    #"mode_indicator ${TMUX_POWERLINE_BACKGROUND_COLOR} ${TMUX_POWERLINE_FOREGROUND_COLOR}"
		#"vcs_branch 29 88"
		#"vcs_compare 60 255"
		#"vcs_staged 64 255"
